...
// Update: Card takes 100% width, parent container has horizontal padding
...
export function Survey() {
    ...
    if (submitted)
        return (
            <div style={{ ...cardStyle, textAlign: "center", marginTop: "3rem", maxWidth: 500, marginLeft: "auto", marginRight: "auto" }}>
                <h2>Thank you for participating!</h2>
                <p>Your answers have been submitted successfully.</p>
            </div>
        );

    // Parent container with horizontal padding
    return (
        <form
